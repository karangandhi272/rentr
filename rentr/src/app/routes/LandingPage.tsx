  ...
  const features = [
    {
      ...
      description: "Easily manage all your properties in one place with detailed insights and analytics.",
    },
    {
      icon: <Calendar className="w-6 h-6 text-zinc-600" />,
      title: "Smart Scheduling",
      description: "Automated viewing schedules and tenant applications management.",
    },
    {
      icon: <MessageSquare className="w-6 h-6 text-zinc-600" />,
      title: "Instant Communication",
      description: "Direct messaging with potential tenants and automated notifications.",
    },
  ];
  ...
  const benefits = [
    {
      ...
      description: "Simplified tenant application process with digital forms and automatic screening."
    },
    {
      icon: <Users className="w-12 h-12 text-green-500 mb-4" />,
      title: "Lead Management",
      description: "Track and manage potential tenants with our intuitive lead management system."
    },
    {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-b from-white to-zinc-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold text-gray-900">Rentr</span>
            </div>
            <nav className="hidden md:flex space-x-8">
              <a href="#features" className="text-gray-600 hover:text-zinc-900 transition-colors">
                Features
              </a>
              <a href="#benefits" className="text-gray-600 hover:text-zinc-900 transition-colors">
                Benefits
              </a>
              <Button 
                variant="default" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-500">
              Streamline your property management workflow with automated scheduling, 
              tenant applications, and communication tools.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-2 hover:border-zinc-800 transition-all duration-300">
                <CardHeader>
      ...
      <section id="benefits" className="py-20 bg-zinc-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900">Why Choose Rentr</h2>
            <p className="mt-4 text-lg text-gray-600">
